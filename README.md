...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ruuqw50.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ruuqw50.containers.anotherwebservice.com/
...
```
git clone git@github.com:thaler476/container-ruuqw50.git
cd container-ruuqw50
```
...
```
docker attach container-ruuqw50
```
